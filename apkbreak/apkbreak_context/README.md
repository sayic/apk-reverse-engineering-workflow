...
Create actual task records from [summary.md](templates/summary.md) and [status.json](templates/status.json). Use [changes.csv](templates/changes.csv) when formal files change. Empty templates are not executed tasks.
...
- Simplified extraction records:
  ...
  - Use the parsed-resource query/analysis skill for later specific lookups. Repairs, mappings, and imports into other projects still require explicit targets.
  ...
  "stages": [
    {
      ...
      "status": "completed",
      "input_paths": [
        "apkbreak/apkbreak_apks/sample_game_a_v1.xapk"
      ],
      "output_paths": [
        "apkbreak/apkbreak_unpacked/sample_game_a_v1_code_20000101_120000_unpacked"
      ],
      "log_paths": [],
      "issue": "",
      "next_action": ""
    },
    {
      ...
      "log_paths": [
        "apkbreak/apkbreak_context/sample_game_a_v1_extract_20000101_120000/logs/convert_code_ilspy_20000101_120500.log"
      ],
...
- Rules:
  ...
  3. Update at stage start/completion/failure/pause. The main skill and subskills share this file.
...
- The query skill mainly writes summary.md in the current query task directory, recording the question, versions, conclusions, evidence paths, and unresolved items.
