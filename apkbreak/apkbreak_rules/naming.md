...
- Scope:
  - Applies to new management directories, tools, logs, reports, and artifact root directories in this project.
...
- File and directory names:
  - Packages: apkbreak/apkbreak_apks/game_id_project_version.original_extension.
  - Intermediates: apkbreak/apkbreak_unpacked/game_id_project_version_resource_type_task_time_unpacked.
  - Parsed artifacts: game_id_project_version_resource_type_outputs at the repository root.
  - Task records: apkbreak/apkbreak_context/game_id_project_version_task_type_task_time.
...
- Task types:
  ...
  - Subflows reuse the main task directory; do not create separate tasks merely because another skill is called.
...
apkbreak/apkbreak_unpacked/sample_game_a_v1_art_20000101_120000_unpacked/
