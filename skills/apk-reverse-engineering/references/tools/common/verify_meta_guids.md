...
```powershell
python "<configured-tool-directory>/common/verify_meta_guids.py" "unpacked/task_directory/source_assets" "unpacked/task_directory/target_assets" --report "context/task_directory/logs/guid_run1.json"
```
