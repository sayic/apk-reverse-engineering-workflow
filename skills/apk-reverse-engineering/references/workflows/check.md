...
- Use case: the user requests checking directories, filenames, and storage locations against shared rules, or explicitly requests convention checks before delivery or submission.
- Required inputs:
...
- Boundaries:
  ...
  - Naming compliance does not establish completeness or runtime usability. Content parsing, compilation, and runtime acceptance are outside this workflow.
  - Do not commit to SVN on your own.
- Steps:
  1. Read shared rules to establish targets, applicable rules, and exceptions. Record rule conflicts for confirmation rather than choosing arbitrarily.
