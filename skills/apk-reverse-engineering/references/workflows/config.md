...
- Boundaries:
  ...
  - This workflow restores/exports data. Modifying another project's tables belongs to the table-mapping workflow.
...
- Registered tools and format experience:
  - Use [resolve_table_vext](../tools/games/sample_game_a/resolve_table_vext.md) for already-decoded index/data/vExt structures to restore fields by positions/reference flags. Raw Lua/binary decoding requires suitable tools.
